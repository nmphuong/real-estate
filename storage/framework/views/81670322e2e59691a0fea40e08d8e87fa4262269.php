...
<body class="bg-warning">
    ...
    <script>
        swal("Thất Bại", "<?php echo e(session('error')); ?>", "error");
    </script>
    <?php endif; ?>
    <div class="row" style="position: absolute; top: 50%; transform: translate(0, -50%);">
		<div id="logo" class="col-lg-6 logo h-100 text-center">
            <img class="w-50" src="<?php echo e(asset('img/logo.png')); ?>" alt="">
		</div>
        <br>
        <div class="col-lg-6 h-100 text-center">
        <form action="<?php echo e('xu-ly-dang-nhap'); ?>" method="POST" id="form-login" class="login form-group w-50">
            <?php echo csrf_field(); ?>
...
</html><?php /**PATH /home/arqyxqvohosting/public_html/nhadatchinhchu.billionaire-land.net/resources/views/Admin/Login.blade.php ENDPATH**/ ?>
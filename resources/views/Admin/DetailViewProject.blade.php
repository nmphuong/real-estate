...
<body>
    <div class="container-fluid">
                        <!-- Page Heading -->
        <h1 class="h3 mb-2 text-gray-800" style="text-align: center;"><b style="color:red">Dự án</b> {{$news->news_title}}</h1>
                        <!-- DataTales Example -->
                ...
                <div class="row">
                    ...
                    <div class="col-md-5 mb-4 mb-md-0">
                      ...
                      <div class="mdb-lightbox">
                        ...
                        <h5>Mô Tả: </h5>
                        <p class="pt-1">{{$news->news_description}}</p>
                            ...
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td class="w-100">{{ number_format($news->news_price_meters_from, 0, '', ',') }} VND</td>
                                    <tr>
                                    <tr>
                                        <th class="pl-0 w-25" scope="row"> Địa chỉ </th> 
                                        <td>{{$news->news_street}}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>

    ...
    <div id="app" style="background: #cca4f1">
        <nav class="navbar navbar-expand-md navbar-light shadow-sm" style="background: aliceblue">
            <div class="container p-0 m-0 ">
                <div class="row">
                    <div class="col-6">
                        <a href="{{ route('statistical-admin') }}" style="text-decoration: none">
                            <div class="img_logo">
                                <img src="{{asset('img/logo_brown.png')}}" alt="logo" width="160" height="70">
                            </div>
                                ...
                                <a id="navbarDropdown"  class=" nav-link dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    <div class="row mr-5 w-100">
                                        ...
                                        <div class="col-6">
                                            ...
                                            src="{{asset('img/undraw_profile.svg')}}" width="40"> 
                                        </div>
                                    </div>
                                </a>
